...
class ContainerHatInventory(playerInv: InventoryPlayer, private val thePlayer: EntityPlayer) : Container(), IRecipeContainer {
    ...
    init {
        ...
        this.addSlotToContainer(object : Slot(HatInventoryWrapper(CapabilityHatContainer.getCapability(thePlayer)), 0, 77, 8) {
            override fun isItemValid(stack: ItemStack) = stack.item is ItemHat
            override fun getSlotTexture() = GuiTextureEvents.SLOT_HAT.toString()
        })
